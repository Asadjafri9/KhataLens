      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-6">
        <div 
          className={`flex flex-col items-center transition-all duration-1000 ease-in-out ${
            showForm ? "opacity-0 scale-150 blur-2xl pointer-events-none absolute" : "opacity-100 scale-100 blur-0"
          }`}
        >
        ...
        <div
          className={`w-full max-w-md transition-all duration-1000 ease-out ${
            showForm ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-24 scale-95 pointer-events-none blur-xl"
          }`}
        >
          <div className="glass-card overflow-hidden rounded-[40px] p-8 sm:p-10">
            ...
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); navigate('/customer'); }}>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="group relative flex h-14 w-full items-center justify-center overflow-hidden rounded-2xl bg-primary font-bold text-white transition-all hover:bg-primary-deep active:scale-[0.98] shadow-lg shadow-primary/20"
                >
            ...
            <div className="mt-8 flex flex-col items-center gap-4 border-t border-border/50 pt-8">
              <button 
                ...
                className="text-xs font-bold uppercase tracking-widest text-primary hover:text-primary-deep transition-colors"
              >
